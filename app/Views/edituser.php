...
<body>
    ...
    <form action="<?=base_url('home/aksi_e_user')?>" method="post">
        ...
        <input type="text" id="nama" name="nama" value="<?=$a->username?>"><br><br>

        <label for="level">Level</label><br>
        <input type="text" id="level" name="level" value="<?=$a->level?>"><br><br>

        <label for="pass">Password</label><br>
        <input type="text" id="pass" name="pass" value="<?=$a->password?>"><br><br>
